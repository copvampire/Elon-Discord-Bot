...
const config = {
    ...
    "defaultSettings": {
        "prefix": "!",
        "modLogChannel": "bot-test",
        "modRole": "Moderator",
        "adminRole": "Administrator",
        "systemNotice": "true", // This gives a notice when a user tries to run a command that they do not have permission to use.
        "commandReply": "true", // Toggle this if you want the bot to ping the executioner or not.
        "welcomeChannel": "welcome",
        "welcomeMessage": ":rocket: :rocket: Welcome {{user}}!! Together we shall woreship our beloved leader Elon Musk!! :rocket: :rocket:",
