...
module.exports = async client => {
  ...
  var startMessage = new MessageEmbed()
  .setColor("RANDOM")
  ...
  client.channels.cache.get("338825465768706049").send({ embeds: [startMessage] });


  // schedule.scheduleJob("* * * * *", function () {
  //   client.channels.cache.get("338825465768706049").send("/collect");
  // });
